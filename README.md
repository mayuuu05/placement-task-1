...
4. **Dark & Light Theme** 🌙☀️: The app supports both Dark and Light themes, with the user's last modified theme preference saved using SharedPreferences. The app remembers the last theme used, providing a seamless experience for the user.
...
### Screenshots 📸:
(Include relevant screenshots of the app, if possible)
